...
//        let bc = SimpleMKLabelledExercise(exerciseId: "bc", start: NSDate(timeIntervalSinceReferenceDate: 0), duration: 1, repetitions: 10, intensity: 0.8, weight: 8)
//        let te = SimpleMKLabelledExercise(exerciseId: "te", start: NSDate(timeIntervalSinceReferenceDate: 2), duration: 1, repetitions: 10, intensity: 0.9, weight: 9)
