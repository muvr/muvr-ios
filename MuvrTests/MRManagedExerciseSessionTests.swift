...
class MRManagedExerciseSessionTests : MRCoreDataTestCase {
    ...
    func testClassificationHints() {
        ...
        let givenDetail: MKExerciseDetail = MKExerciseDetail(id: "foo/bar", type: MKExerciseType.IndoorsCardio, properties: [])
    ...
    func testAddExerciseDetail() {
        ...
        let givenDetail: MKExerciseDetail = MKExerciseDetail(id: "foo/bar", type: MKExerciseType.ResistanceWholeBody, properties: [])
