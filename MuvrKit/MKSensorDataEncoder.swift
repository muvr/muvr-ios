...
public final class MKSensorDataEncoder {
    ...
    public func close() {
        ...
        var types = self.types.flatMap { (type: MKSensorDataType) -> [UInt8] in
            switch type {
            case .Accelerometer(location: .LeftWrist, _):  return [UInt8(0x74), UInt8(0x61), UInt8(0x6c), UInt8(0x52)]
            case .Accelerometer(location: .RightWrist, _): return [UInt8(0x74), UInt8(0x61), UInt8(0x72), UInt8(0x52)]
