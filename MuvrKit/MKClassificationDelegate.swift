...
protocol MKClassificationDelegate {
    ...
    ///
    func classificationCompleted(classified: [(MKExercise, [MKExerciseLabel])], fromSensorData data: MKSensorData)
    ...
    ///
    func classificationEstimated(estimated: [(MKExercise, [MKExerciseLabel])])
