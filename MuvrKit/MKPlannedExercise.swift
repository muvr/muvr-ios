...
public struct MKPlannedExercise : Hashable, MKExercise {
    ...
    ///
    public init(exerciseId: MKExerciseId, repetitions: UInt? = nil, intensity: MKExerciseIntensity? = nil, weight: Double? = nil) {
    ...
    public init(labelledExercise: MKLabelledExercise) {
        ...
        self.repetitions = UInt(labelledExercise.repetitions)
